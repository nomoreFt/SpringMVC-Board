...
<form action = "" method="post">
		...
		<div class="form-group">
			...
			<input type="text" value="DB.user_name">
			<div class="check_font" id="name_check"></div>
		</div>
		<!-- 아이디 -->
		<div class="form-group">
			<label for="user_id">아이디</label> 
			<input type="text" value="DB.user_id">
		...
		<div class="form-group">
			<label for="user_phone">휴대전화 ('-' 없이 번호만 입력해주세요)</label> 
				<input type="text" value="DB.user_phone">
			<div class="check_font" id="phone_check"></div>
		</div>
		<!-- 본인확인 이메일 -->
		<div class="form-group">
			<label for="user_email">이메일</label> 
				<input type="text" value="DB.user_email">
			<div class="check_font" id="email_check"></div>
		</div>
		<!-- 주소 -->
		<div class="form-group">
			<label for="user_email">주소</label> 
				<input type="text" value="DB.user_addr">
		...
		<div class="form-group">
			...
			<input type="button" id="delete_check" value="탈퇴하러가기...">
